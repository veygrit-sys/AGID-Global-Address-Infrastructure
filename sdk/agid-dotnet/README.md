...
| Runtime | .NET 8 |
| Primary use | Enterprise, Windows, POS, and hotel systems |
...
Before publishing this SDK, run `dotnet test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
