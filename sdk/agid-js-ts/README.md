...
| Primary use | Web apps, Node.js, and developer tooling |
...
Before publishing this SDK, run `npm test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
