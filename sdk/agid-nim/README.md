...
| Runtime | Nim >=2.0 |
| Primary use | Native tooling and compact services |
...
Before publishing this SDK, run `nimble test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
