...
| --- | --- |
| Language | Kotlin |
| Package | `org.agid:agid-kotlin` |
| Ecosystem | mobile |
| Package manager | Gradle |
| Runtime | Kotlin/JVM |
| Primary use | Android and JVM services |
...
Before publishing this SDK, run `./gradlew test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
