...
| Package manager | pub |
| Runtime | Dart >=3.0 |
| Primary use | Flutter and Dart services |
...
Before publishing this SDK, run `dart test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
