...
| Runtime | Swift 5.9 |
| Primary use | iOS, macOS, and Apple platform apps |
...
Before publishing this SDK, run `swift test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
