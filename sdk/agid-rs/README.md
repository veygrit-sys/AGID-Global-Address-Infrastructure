...
| Runtime | Rust 2021 |
| Primary use | Native core, servers, embedded, and FFI |
...
Before publishing this SDK, run `cargo test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
