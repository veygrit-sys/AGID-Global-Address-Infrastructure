...
| --- | --- |
| Language | Java |
| Package | `org.agid:agid` |
| Ecosystem | enterprise |
| Package manager | Maven |
| Runtime | Java >=17 |
| Primary use | Enterprise JVM and Android-compatible integrations |
...
Before publishing this SDK, run `mvn test` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
