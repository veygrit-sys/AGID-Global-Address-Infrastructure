...
| Runtime | PHP >=8.2 |
| Primary use | Commerce and CMS integrations |
...
Before publishing this SDK, run `vendor/bin/phpunit` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
