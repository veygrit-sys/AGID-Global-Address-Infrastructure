...
| --- | --- |
| Language | Go |
| Package | `github.com/agid/agid-go` |
| Ecosystem | server |
| Package manager | Go modules |
| Runtime | Go >=1.22 |
| Primary use | Server services and delivery APIs |
...
Before publishing this SDK, run `go test ./...` and confirm every parity vector in `agid-parity-vectors.json` matches the canonical `agid-spec/test-vectors.json`.
