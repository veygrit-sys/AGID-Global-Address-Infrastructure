...
test('configured store advertises all supported country packs independently', () => {
  ...
  assert.deepEqual(
    store.statuses().filter(status => !['BL', 'MF', 'GF', 'GP', 'MQ', 'GS', 'SC', 'PR', 'AC'].includes(status.countryCode)).map(status => [status.countryCode, status.state]),
    [['JP', 'unconfigured'], ['US', 'unconfigured'], ['CA', 'unconfigured'], ['MX', 'unconfigured'], ['CU', 'unconfigured'], ['AR', 'unconfigured'], ['UY', 'unconfigured'], ['VC', 'unconfigured'], ['EC', 'unconfigured'], ['SV', 'unconfigured'], ['GT', 'unconfigured'], ['CR', 'unconfigured'], ['CL', 'unconfigured'], ['DO', 'unconfigured'], ['HT', 'unconfigured'], ['PA', 'unconfigured'], ['PY', 'unconfigured'], ['BB', 'unconfigured'], ['TC', 'unconfigured'], ['AI', 'unconfigured'], ['FK', 'unconfigured'], ['NI', 'unconfigured'], ['BR', 'unconfigured'], ['VE', 'unconfigured'], ['PE', 'unconfigured'], ['CO', 'unconfigured'], ['CP', 'unconfigured'], ['PM', 'unconfigured'], ['SG', 'unconfigured'], ['NL', 'unconfigured'], ['GB', 'unconfigured'], ['FR', 'unconfigured'], ['NZ', 'unconfigured'], ['IS', 'unconfigured'], ['IT', 'unconfigured'], ['EE', 'unconfigured'], ['CH', 'unconfigured'], ['DE', 'unconfigured'], ['CZ', 'unconfigured'], ['SK', 'unconfigured'], ['SI', 'unconfigured'], ['NO', 'unconfigured'], ['HU', 'unconfigured'], ['FI', 'unconfigured'], ['FO', 'unconfigured'], ['BG', 'unconfigured'], ['BY', 'unconfigured'], ['BE', 'unconfigured'], ['ME', 'unconfigured'], ['RO', 'unconfigured'], ['TW', 'unconfigured'], ['KR', 'unconfigured'], ['SA', 'unconfigured'], ['OM', 'unconfigured'], ['ZA', 'unconfigured'], ['EG', 'unconfigured'], ['MA', 'unconfigured'], ['DZ', 'unconfigured'], ['EA', 'unconfigured'], ['ET', 'unconfigured'], ['CV', 'unconfigured'], ['KE', 'unconfigured'], ['ZM', 'unconfigured'], ['SN', 'unconfigured'], ['SO', 'unconfigured'], ['TZ', 'unconfigured'], ['TN', 'unconfigured'], ['NG', 'unconfigured'], ['NA', 'unconfigured'], ['NE', 'unconfigured'], ['MG', 'unconfigured'], ['MU', 'unconfigured'], ['MZ', 'unconfigured'], ['LR', 'unconfigured'], ['IN', 'unconfigured'], ['PK', 'unconfigured'], ['BD', 'unconfigured'], ['BT', 'unconfigured'], ['ID', 'unconfigured'], ['PH', 'unconfigured'], ['BN', 'unconfigured'], ['VN', 'unconfigured'], ['MY', 'unconfigured'], ['MM', 'unconfigured'], ['MV', 'unconfigured'], ['MN', 'unconfigured'], ['JO', 'unconfigured'], ['LA', 'unconfigured'], ['LB', 'unconfigured'], ['AF', 'unconfigured'], ['IL', 'unconfigured'], ['IQ', 'unconfigured'], ['IR', 'unconfigured'], ['UZ', 'unconfigured'], ['KZ', 'unconfigured'], ['CN', 'unconfigured'], ['KH', 'unconfigured'], ['KG', 'unconfigured'], ['KW', 'unconfigured'], ['BH', 'unconfigured'], ['DK', 'unconfigured'], ['MT', 'unconfigured'], ['MC', 'unconfigured'], ['AU', 'unconfigured'], ['LV', 'unconfigured'], ['LT', 'unconfigured'], ['LI', 'unconfigured'], ['AZ', 'unconfigured'], ['AL', 'unconfigured'], ['AM', 'unconfigured'], ['AD', 'unconfigured'], ['UA', 'unconfigured'], ['AT', 'unconfigured'], ['CY', 'unconfigured'], ['GR', 'unconfigured'], ['HR', 'unconfigured'], ['RS', 'unconfigured'], ['GE', 'unconfigured']],
  );
  assert.equal(store.countryStatus('PR').state, 'unconfigured');
  assert.equal(store.countryStatus('AC').state, 'unconfigured');
  assert.equal(store.countryStatus('BL').state, 'unconfigured');
  assert.equal(store.countryStatus('MF').state, 'unconfigured');
  assert.equal(store.countryStatus('GF').state, 'unconfigured');
  assert.equal(store.countryStatus('GP').state, 'unconfigured');
  assert.equal(store.countryStatus('MQ').state, 'unconfigured');
  assert.equal(store.countryStatus('GS').state, 'unconfigured');
