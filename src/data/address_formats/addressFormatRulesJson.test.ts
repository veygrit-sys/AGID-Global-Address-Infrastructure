...
test('Americas country JSON files expose addressRules, Spanish delivery metadata, and open sources', () => {
  ...
  assert.deepEqual(loadRules('MX').regionalHierarchy, [
    'country', 'federative_entity', 'municipality_or_territorial_demarcation', 'locality',
    'five_digit_postal_area', 'human_settlement_or_colonia', 'street_or_road',
    'civic_address', 'economic_establishment_or_building_unit',
  ]);
  ...
  assert.deepEqual(loadRules('DO').regionalHierarchy, [
    'country', 'planning_region', 'province_or_national_district', 'municipality',
  ...
  assert.deepEqual(loadRules('BR').regionalHierarchy, [
    'country', 'great_region', 'federative_unit', 'intermediate_geographic_region',
    'immediate_geographic_region', 'municipality_or_federal_district',
