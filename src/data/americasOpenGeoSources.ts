...
export const AMERICAS_OPEN_GEO_SOURCES: Record<AmericasOpenGeoSourceId, AmericasOpenGeoSource> = {
  ...
  'bvi-post': {
    ...
    url: 'https://gov.vg/virgin-islands-postal-services',
    kind: 'postal-code',
    coverage: 'territory',
    usage: 'primary',
    notes: 'Current official Virgin Islands Postal Services page confirming the operator and service mandate; it is not a versioned assignment or postal-area download.',
  },
  'bvi-gis': {
    id: 'bvi-gis',
    name: 'British Virgin Islands Government GIS Reference',
    url: 'https://gov.vg/town-and-country-planning-department',
    kind: 'admin-boundary',
    coverage: 'territory',
    usage: 'reference',
    notes: 'Official planning and National Addressing System context only. Administrative, civic-address and building context must not be substituted for postal polygons.',
  },
  'cayman-post': {
    id: 'cayman-post',
