...
- Result: `m2_verified` / `M2_current_laposte_single_postcode_derived_collectivity_visualization` at `2026-09-01T12:57:00.981Z`.
- Official assignment: the complete 39,192-row La Poste snapshot has exactly one 978-prefix row and one 97150 row: INSEE `97801`, Saint-Martin, postcode `97150`. The data update is 2026-08-08; the fixed CSV SHA-256 is `f921ac020ca3b9efebd8f0d01782555fb70d63d1ae36535109c67e4a74bd6e22`.
- Geometry and authority: fixed `geo.api.gouv.fr` queries by code 97801 and postcode 97150 return the same real 11-part MultiPolygon. Its 11 closed rings / 2,136 positions pass Turf and JSTS. Coordinates are unchanged; the surface is `derived` administrative display context with confidence `0.97`, never an official postal, legal, survey, cadastral or delivery boundary.
- Rights and privacy: La Poste assignment data and government geometry are reused under Etalab Open Licence 2.0 with attribution. Postal assignment and geometry authorities remain separate. No address, building, parcel, recipient, customer, deliverability or land-right row is published; no point, route, PO box, organization, buffer, hull, Voronoi/raster cell or synthetic fixture was promoted.
- Application: the actual Express app and Chromium normalized MF `97150`, followed an actual OpenStreetMap result and issued two HTTP 200 requests to `/api/v1/postal/MF/97150`. The live DOM exposed code, MultiPolygon, derived class, one area, source, 2026-09-01 reference date and confidence 0.97; clear and re-search passed. Testing exposed and fixed an umbrella-country bug where geocoder FR could override an explicit MF filter.
- Visual evidence limit: the supported interactive browser/image-inspection helper failed Windows ACL initialization after retry and reset. Manual visual inspection is not claimed. Deterministic Chromium evidence records two map canvases, a temporary 1440 x 1000 render (excluded from Git), both real API responses and the tested bounds-fit / opacity-`0.22` fill / opacity-`0.95`, width-`3` outline contract.
- Verification: focused MF policy/repository/topology/API/store `12/12`, shared runtime `162/162`, shared postal-area UI `7/7`, TypeScript, JSON/diff audit and an independent byte-identical rebuild pass (`183` recorded checks, `0` failed).
- Evidence commit: `9183040831e1474ede393193693c1692aa6f975c`; descriptor `sha256:73b833176a1638cc7de680ad5874d76d9519dca780b9e87ad5a42e26ec5112e4`, graph `sha256:e092425a20160611fe8c94715b77a8abb11390c819a9e5636c25b14802a89f65`, geometry `sha256:1120b3e9896198169cbba4f2e2aad4ef769585660b2c8c2f8ebf19404eac8a37`.
...
- Result: `m2_verified` / `M2_current_laposte_single_postcode_two_commune_visualization` at `2026-09-02T00:59:23.452Z`.
- Official assignment: the complete 39,192-row La Poste snapshot has exactly three PM rows: two routing-line variants for INSEE `97501` Miquelon-Langlade and one for `97502` Saint-Pierre; all assign the single postcode `97500`. The source data update is 2026-08-08 and the fixed CSV digest is `sha256:f921ac020ca3b9efebd8f0d01782555fb70d63d1ae36535109c67e4a74bd6e22`.
- Geometry and quality: fixed `geo.api.gouv.fr` responses for 97501, 97502 and postcode 97500 agree exactly. Their coordinate-preserving combination is one real 78-part / 78-ring / 9,097-position MultiPolygon covering 219,096,973.58 square metres and passing Turf, JSTS and shared topology checks. It is `derived` administrative display context with confidence `0.95`, never an official postal, legal, survey, cadastral or delivery boundary.
- ID-linked detail: the API and UI expose `postal-pm-97500`, `admin-pm-insee-97501` / Miquelon-Langlade, `admin-pm-insee-97502` / Saint-Pierre, two La Poste evidence assertion IDs and pinned release `pm-laposte-geoapi-single-postcode-20260901`. Postal assignment, display polygon and address/building context remain separate; no address, building, parcel, recipient, customer, deliverability or land-right row is published.
- Application and visual check: the actual app and Playwright Chromium normalized PM `97500` and issued two HTTP 200 requests to `/api/v1/postal/PM/97500?geometry=geojson`. The committed screenshot was manually inspected: all islands were fitted, the background basemap stayed visible through the translucent blue fill, the dark outline was clear, and the expanded result panel showed the postal/admin/assertion/release IDs, source, date, geometry type, provenance and confidence. Clear and re-search passed. The Browser Plugin failed Windows ACL setup and is not claimed; only search-result transport used a deterministic fixture because public Nominatim returned no PM result, while the Postal Context API, committed geometry, MapLibre rendering and fit were real.
- Ancillary limit: nearest-postcode, building-name and Overpass address enrichment returned 404/503/400 respectively. They are recorded separately, were not used to satisfy M2 and did not substitute any address or building surface. Postal Context itself had zero failed requests.
- Verification: PM policy/repository/topology/API/app `18/18`, shared runtime `169/169`, actual-app browser visual `1/1`, TypeScript, JSON/diff audit and independent descriptor/graph/geometry rebuild all pass (`188` recorded checks, `0` failed).
- Evidence commit: `91bc2aa7d3c9393a0670fb5ddd25fc71074094ca`; descriptor `sha256:eefdebc10d77d0adb486c788f9c8a2c6b2129e247b18cec2c6d69f3815b64f1d`, graph `sha256:2bd78b059384f1c0e0cc17cccb71605aeec7f4c96f3867075dfd1468e3e90407`, geometry `sha256:7539ca7cc78f27d8b993ee05565fd9d782c5dc24061e263f0ae8f90605d591b9`.
- Reports: `reports/postal-context-m2/pm-current-single-postcode-2026-09-01.json`, `reports/postal-context-m2/pm-browser-validation-2026-09-02.json`, `reports/postal-context-m2/pm-browser-visual-2026-09-02.png`, and `data/postal_country_packs/pm/postal-context/README.md`.
- After PM: 252 profiles, 103 pending, 131 blocked, 0 in progress, 18 evidence-verified M2; 175 manifests / 161 explicit definitions.
- Next country: Puerto Rico (`PR`). No second country was started.

## PR - Puerto Rico

- Status: `blocked` / full rollout M2 unmet. A fixed real-data Census ZCTA display path is implemented, but no authoritative current complete redistributable USPS Puerto Rico assignment denominator was established.
- Attempt: 1 from `2026-09-02T01:28:11.9932986Z`; completed `2026-09-02T02:38:45.3873806Z`.
- Definition: `M2_current_usps_complete_assignment_and_census_zcta_derived_display_visualization`.
- Postal and rights boundary: current USPS PostalPro material confirms Puerto Rico prefix range `006-009`; Publication 28 (October 2024) fixes the urbanization line and literal `PR` address form. The July 2026 USPS licence constrains copying, modification and distribution. Zero licensed USPS rows, addresses, buildings, parcels, recipients, customers or land-right data were added to Git.
- Polygon quality: the fixed current TIGERweb query for 2020 Census ZCTAs returns 132 unique real features, 142 polygon parts, 152 closed rings and 168,582 positions. Coordinate-preserving Turf, JSTS and shared topology validation passes; aggregate geodesic area is 9,487.290179 km². These are `derived` statistical display areas, never official USPS delivery boundaries, and Census notes they do not cover every valid ZIP.
- ID-linked detail: `00926` resolves to `postal-pr-census-zcta-00926`, geometry `census-pr-zcta-2020-00926`, assertion `census-pr-zcta-2020-00926-part-of-pr`, linked context `country-pr` and release `pr-census-zcta-2020-20260902`. The UI also shows population, housing, land/water area, source, licence, digest, reference date, confidence and authority boundary. ZIP+4 `00926-3232` normalizes to `00926`; `00902` is explicit no-match without a fabricated polygon.
- Application and visual check: the actual app and Postal Context API returned HTTP 200. Deterministic Playwright intercepted only geocoder transport; real committed geometry, API, MapLibre fit/render, clear and re-search remained active. Desktop and mobile screenshots were manually inspected: the basemap remains visible through the translucent fill, the dark outline is clear and IDs are readable. Search-result focus and mobile panel overlap defects found in the loop were corrected. In-app Browser initialization failed on Windows deny-read ACLs and is not claimed as evidence.
- Verification: deterministic build 1/1, PR normalization/topology/API/store/UI 20/20, shared runtime 169/169, address/search/QR UI 72/72, TypeScript, JSON and staged diff checks, plus actual-app desktop/mobile visual flow all pass (`262` automated checks, `0` failed). Ancillary nearest-postcode, building-name and Overpass failures are recorded separately; Postal Context requests had zero failures.
- Evidence commit: `a1f1cd6bfb43c5b9e2e5589c788a6fdb99b1e7b5`; descriptor `sha256:876abe3dafe711d950d6de645103355d2bdaecbe48f92d48ec70e0df40864309`, graph `sha256:c4a5bd6b184a70783aa912919a9cc6e69fa4946490e81e5801412118113932e9`, geometry `sha256:18100ed3686ac3a0f7615c8697c7fbace7ed8b02928774164384101aed0153dc`.
- Reports: `data/postal_country_packs/pr/postal-context/source-profile.json`, `reports/postal-context-m2/pr-current-zcta-2026-09-02.json`, `reports/postal-context-m2/pr-browser-validation-2026-09-02.json`, desktop/mobile screenshots and `reports/postal-context-m2/pr-visual-polygon-2026-09-02.md`.
- Retry: not before `2026-12-02` and only after pending countries have been swept. Provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After PR: 252 profiles, 102 pending, 132 blocked, 0 in progress, 18 evidence-verified M2; 176 manifests / 162 explicit definitions.
- Next country: Paraguay (`PY`). No second country was started.

## PY - Paraguay

- Result: `m2_verified` / `M2_current_national_dinacopa_postal_zone_derived_area_visualization` at `2026-09-02T06:19:02.9680112Z`.
- Official assignment and rights: fixed DINACOPA dataset `2ba6d169-85d9-433e-ad44-aefa320ceff7` contains 8,646 official EPSG:32721 source areas, 2,887 distinct six-digit codes, 18 departments and 259 department/district pairs. Current Correo Paraguayo material confirms the two-digit department + two-digit district + two-digit barrio structure and `001518`. Public-information reuse under Decree 4064 and Law 5282/2014 permits copying, distribution, adaptation and transformation with source, licence and update attribution and no official-endorsement implication.
- Polygon quality: five invalid source polygons are repaired; official areas are unioned by code before 20 m simplification, transformed to EPSG:4326, snapped to `1e-7` degrees and validated. The fixed output has 2,887 non-empty MultiPolygons, 339,723 positions and 8,058 rings. Sixty-three collapsed numerical hole rings and one duplicate position are removed deterministically. Provenance is `derived`, confidence `0.98`; zero surface is invented.
- ID-linked detail: `001518` returns postal `postal-py-001518`, geometry `dinacopa-py-derived-001518`, locality `locality-py-001518-0000052-052-row-00001`, district `admin-py-district-0015`, department `admin-py-department-00` and country `country-py`. All 8,646 official rows retain separate context IDs; repeated `cod_bar` values are never collapsed globally. No address, building, point, route, P.O. box, organization, customer, parcel or land-right area is inferred.
- Application and visual check: the production configured-store test caught and fixed missing PY country registration. Playwright Chromium then used the actual configured API pack, production Postal Context route, MapLibre and 25 successful OpenStreetMap raster tiles. Full-width/spaced `００１ ５１８` normalized to `001518`; one translucent blue MultiPolygon with opacity `0.22` and a clear `0.95` / width-`3` outline was fitted, cleared and reproduced on re-search. The screenshot was manually inspected and its detailed IDs are readable over the basemap.
- Evidence limit: the in-app Browser failed Windows deny-read ACL setup, and the full isolated Vite app could not reuse another worktree's dependency layout without modifying it. Neither path is claimed. This is the permitted deterministic browser fallback using the real configured Postal API/renderer, not a synthetic postal fixture.
- Verification: PY policy/topology/repository/configured-store/API/app `8/8`, shared graph/resolver/schema/topology/postal-area geometry `38/38`, targeted TypeScript, JSON/diff audit and byte-identical rebuild pass (`46` automated checks, `0` failed).
- Evidence commit: `4db0bb649af292e1cb08e872c6411ceadb57dffc`; descriptor `sha256:d12690e3f4a6cf79cab02e756bc7b6b49203561110b8a68c14002ed10d151c99`, graph `sha256:22981da262edfbf7fb6228045ae161763df00ffb405e5e3f580fde52db49eeed`, geometry `sha256:9e8017fec7b2bc69600d78ab47e79fcf90d05690ca6a950524be4c89bea5943e`.
...
- Result: `m2_verified` / `M2_current_upu_single_postcode_decr_derived_visualization` at `2026-09-02T09:55:17.6982489Z`.
- Official assignment: the UPU Turks and Caicos Islands country sheet edition 10/2025 defines `TKCA 1ZZ` as the single postcode for the whole territory; the August 2026 UPU general table corroborates TC. Inputs such as `TKCA1ZZ`, mixed case and NFKC full-width text normalize only to `TKCA 1ZZ`.
- Geometry and rights: the Turks and Caicos Government Data Portal fixes CKAN package `2dcdda81-48c8-4135-b233-c70e34b9c432`, resource `df348511-c995-413c-ac79-cf8b99e16ff2`, the unversioned portal licence identifier `cc-by-sa`, and the exact 11,623,218-byte 2020 GeoJSON. UPU bytes and the raw government body are not committed.
- Polygon quality: 861 source MultiPolygons / 253,775 positions are repaired only at invalid `OBJECTID` 717, dissolved by 27 source regions, topology-preserving simplified at 0.0005 degrees and validated. Thirty-nine valid source-aligned surfaces become two runtime MultiPolygons / 848 parts / 857 rings / 7,838 positions. Source index 101 / `OBJECTID` 102 becomes zero-area and is omitted rather than fabricated. Output area is 933.837245 km², `+0.064015%` from repaired source.
- ID-linked detail and authority: lookup returns `postal-tc-tkca-1zz`, official `country-tc`, the official country assertion, two geometry bundle IDs and the pinned release. Twenty-seven government-source region IDs and derived audit assertions remain reviewable in the graph, but are not promoted as definitive postal/administrative lookup contexts. The surface is `derived`, confidence `0.90`, date `2020-12-02`; it is not an official postal, delivery, legal, survey or cadastral boundary and proves no address, building, parcel, person, population or land right.
- Application contract: the actual shared HTTP API, result conversion and map-layer path return both real MultiPolygons, combine their bounds for fit, retain the background-map-visible opacity-`0.22` fill and opacity-`0.95`, width-`3` outline, and pass clear, re-search, no-match and invalid-geometry checks. In-app browser initialization was attempted but its trusted Node process exited before page connection; no visual inspection is claimed.
- Verification: TC normalization/repository/topology/shared postal-area/API/app `18/18`, exact rebuild with identical descriptor/graph/geometry digests, JSON and staged-diff checks pass. The focused temporary dependency workspace is documented; a full repository TypeScript run was not available in this low-disk execution and is not claimed.
- Evidence commit: `651f0854a26f32b9209f710a1f6f1c6027760349`; descriptor `sha256:bae55b493e9303a8d47bc20ef34371d56fbbcfcd9e012e0b8629b5ce8f4437ac`, graph `sha256:7862d04763fdd206eac9b964429dea18024927ef0e6cf145d054187ab4f20b89`, geometry `sha256:5efdd5add3459c08b853377ab3c2c13f79006b435d1a7cbd5b441677ca7d7cf0`.
...
- Status: `blocked` / M2 unmet. USPS current products and ZIP semantics are confirmed, but no complete current redistributable typed USPS assignment/non-area denominator or real-app browser verification was established.
- Attempt: 1 from `2026-09-02T10:58:00.504Z`; completed `2026-09-02T11:31:00.000Z`.
- Definition: `M2_current_typed_usps_and_fixed_census_zcta_runtime` now explicitly requires complete current five-digit/ZIP+4 assignment, validity, corrections and non-area exceptions plus eligible fixed geometry, stable postal/geometry/assertion/AGID IDs, detailed attributes and actual API/app render/fit/clear/re-search.
- Primary evidence and rights: USPS City State Product material describes approximately 100,000 monthly encrypted, non-exportable records and states that complete five-digit coding needs other AIS products. The July 2026 AIS licence restricts copying, modification and distribution. Census states 2020 ZCTAs are generalized block-based statistical areas, may represent routes/organisations/PO boxes, and do not represent all valid ZIP Codes. Every fixed receipt has URL, retrieval time, version metadata and SHA-256 in the build report; zero licensed USPS rows were published.
- Real data and polygon quality: one coordinate-preserving Census TIGERweb ZCTA `10001` validation sample is committed as `derived`, not USPS geometry. It has one Polygon part, three closed rings, 124 positions, finite WGS84 coordinates and bounds `[-74.00994700020514, 40.74345100004846, -73.98407599972285, 40.75968600024119]`; no missing/non-area surface was invented.
- Detailed ID linkage: postal `postal-us-census-zcta-10001`, geometry `census-us-zcta-2020-10001`, country assertion `census-us-zcta-2020-10001-part-of-us`, derived centroid crosswalk `census-us-zcta-2020-10001-centroid-agid-crosswalk`, and AGID cell `USARPV8JCJET` are exposed. Population 32,612, housing 18,926, land 1.62 km² and water 0.00 km² are retained. The AGID cell is a centroid crosswalk only, never postal coverage.
- App/visual boundary: `npm run dev` was attempted but the isolated worktree lacked `tsx`/`node_modules`; the ambient port-3001 app was not treated as branch evidence. In-app Browser startup exited unexpectedly. Bundled Playwright deterministically rendered the committed Polygon with translucent fill and clear outline; DOM and 1440×900 pixel counts passed. Local image inspection failed twice, so neither human visual inspection nor real API/app visualization is claimed.
- Privacy and authority: zero addresses, buildings, parcels, recipients, customers, occupants or land-right rows were published or inferred. Postal assignment → derived polygon → address context remains separated.
- Verification: pure Node pack/schema/digest/geometry/ID test 1/1, JSON syntax and staged-diff checks pass. Shared TypeScript runtime suites and typecheck were unavailable without dependencies and insufficient safe install space; they are explicitly unrun, not passes.
- Evidence commit: `6c5f2eb42cd4ee9a961b7c27901ba89d04b412df`; descriptor `sha256:4f0a545e96486c595224d0e1907c89fd7d92ec28a6099da89954327c5327c61d`, graph `sha256:24f40daef4d755023d406967938515d97b16e298ddcb0317e9eea2a99761f81c`, geometry `sha256:158bf86250f96c6b2daf72aa74f0735e2fda8667597a9120f5b982f8acb97f29`.
- Reports: `reports/postal-context-m2/us-zcta-validation-2026-09-02.json`, `reports/postal-context-m2/us-engineering-validation-2026-09-02.json`, `reports/postal-context-m2/us-visual-polygon-2026-09-02.md`, and the fixed PNG/text render receipts.
- Retry: not before `2026-12-02T10:58:00.504Z` and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, publication or deployment requires explicit approval.
- After US: 252 profiles, 95 pending, 137 blocked, 0 in progress, 20 evidence-verified M2; 181 manifests / 169 explicit definitions; 22 non-synthetic research artifacts.
- Next country: Uruguay (`UY`). No second country was started.

## UY - Uruguay

- Status: `blocked` / M2 unmet. The latest fixed official catalog body is a one-time August 2023 release; complete current 2026 assignment, alias, correction, exception and supersession state remains unconfirmed.
- Attempt: 1 from `2026-09-02T11:40:31.132Z`; completed `2026-09-02T12:15:00Z`.
- Definition: `M2_current_correo_complete_typed_postal_area_runtime` requires a complete current ordinary Correo denominator, eligible exact Polygon/MultiPolygon, compatible rights, stable postal/official cp_id/geometry/assertion/release/AGID IDs and actual API/app render/fit/clear/re-search. Reserved CPA and address/building/parcel detail remain separate.
- Primary evidence and rights: Correo dataset `7eb3681f-3e58-475d-9cd4-4527dc6ab234` v1.0, KML resource `271e6277-6b0f-44f6-962d-21b8ba88e9e4`, SHP resource `8f701b15-5299-4176-b94e-260f69086494`, licence text and two official PDFs are digest-pinned. Uruguay DAG permits reuse with origin and modification disclosure. Zero reserved detailed CPA rows were published.
- Real data and polygon quality: 121 official features, 121 unique five-digit codes and 121 unique `cp_id` values match exactly between KML and DBF; SHP/KML WGS84 bounds match. Source has 121 Polygon parts / 122 rings / 251,684 positions. One zero-area four-position interior ring at `15400` is removed; output has 121 closed non-zero-area rings / 251,680 positions. Coordinate values are unchanged and no missing surface is fabricated.
- Detailed ID linkage: all 121 records expose postal node, official `cp_id`, geometry, country assertion, release and derived AGID reference IDs. Sample `11000` exposes `postal-uy-correo-2023-11000`, `cp_id 1`, `correo-uy-postal-2023-11000` and AGID interior reference `UY0FZ5D9368V`. The AGID cell is reference-only, never area coverage, address or building authority.
- App/visual boundary: the isolated app failed to start because `tsx`/`node_modules` are unavailable; the ambient port-3001 app was not used. In-app Browser startup exited before navigation. Deterministic Playwright render/fit/clear/re-search/no-match plus DOM and pixel checks passed with opacity `0.24`, 4px outline, 185,787 fill and 15,391 boundary pixels. Local image inspection failed, so no real-app or human visual success is claimed.
- Privacy and authority: zero address, building, parcel, recipient, customer, person or land-right rows were published. Postal assignment → polygon → address context remains separated.
- Verification: UY pack/digest/geometry/ID 1/1 and research-catalog 2/2 pass; JSON syntax and diff checks pass. Shared TypeScript runtime and typecheck were unavailable and are explicitly unrun.
- Evidence commit: `3b442e879324686ae6dc7aad4d72df6b9ba9b4c8`; descriptor `sha256:8b08045027b18f18b5f34f3509edb70e5cd755e2885a21f0e137b7be48d60eb2`, graph `sha256:14af62b23e39b1cc231274a392816d08bdcc8114a1eda3f46bb7c4086db315b2`, geometry `sha256:4eea917d0009855e5bc3fb8bd64500d402f88000878d6401ede17f460054654c`.
- Reports: `reports/postal-context-m2/uy-fixed-official-release-2026-09-02.json`, `reports/postal-context-m2/uy-engineering-validation-2026-09-02.json`, `reports/postal-context-m2/uy-visual-polygon-2026-09-02.md` and fixed PNG/text draw receipts.
- Retry: not before `2026-12-02T11:40:31.132Z` and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, publication or deployment requires explicit approval.
- After UY: 252 profiles, 94 pending, 138 blocked, 0 in progress, 20 evidence-verified M2; 181 manifests / 170 explicit definitions; 23 non-synthetic research artifacts.
- Next country: Saint Vincent and the Grenadines (`VC`). No second country was started.

## VC - Saint Vincent and the Grenadines

- Status: `blocked` / M2 unmet. SVG Post and UPU confirm the current `VCNNNN` system, and VC remains in postcode-data creation scope.
- Attempt: 1 from `2026-09-02T12:27:31.870Z`; completed `2026-09-02T13:08:17Z`.
- Definition: `M2_current_svgpost_complete_typed_assignment_and_postal_area_visualization` requires a complete current typed assignment and explicit area/non-area denominator, eligible real postal Polygon/MultiPolygon, compatible rights, separate postal/administrative/geometry/assertion/release/address/building/AGID IDs and actual API/app render/fit/clear/re-search.
- Primary evidence: five exact SVG Post, UPU and Statistical Office bodies / 815,998 bytes are digest-pinned outside Git. SVG Post's current official page lists 58 distinct codes from `VC0100` through `VC0472`, including post-box and general-delivery objects. The UPU edition 05/2021 sheet confirms six-character format, separate-line placement, mainly P.O.-box/post-office delivery and very limited home delivery.
- Geometry and rights: the reviewed postal sources expose no versioned complete typed assignment release, compatible reusable dataset rights or postal boundary artifact. The Statistical Office's 13 Census Divisions are explicitly census-administration geography; its open licence does not extend to SVG Post or UPU. Zero census/locality/point/route/address/building/buffer/hull/raster/Voronoi/AGID proxies and zero production surfaces were promoted.
- Address and detailed IDs: VC address metadata now requires and normalizes `VC` plus four digits on a separate line below locality. Postal object, administration, geometry, source assertion, release, civic address, building and AGID crosswalk identifiers remain independently typed; unknown relations stay null rather than being inferred from the code.
- App/visual boundary: isolated startup failed because `tsx`/`node_modules` are unavailable; in-app Browser startup failed before connection and ambient port 3001 refused connection. A deterministic Playwright fail-closed screen for `VC0120` passed with zero SVG/canvas/postal areas and all separate ID fields visible. Local image inspection failed on the Windows path, so no real VC API, map fit, translucent polygon or human visual success is claimed.
- Verification: exact-source inspection 1/1, inspector regression 4/4, direct TypeScript policy assertions 4/4, VC ledger 5/5, rollout/research shared Node tests 10/10, JSON structure 6/6 and diff checks pass. Shared `tsx` runtime tests and typecheck were unavailable and are explicitly unrun.
- Evidence commit: `3715ce70050fe4b050dcd48ca1d998d36784561e`; reports `reports/postal-context-m2/vc-source-review-2026-09-02.json`, `reports/postal-context-m2/vc-engineering-validation-2026-09-02.json`, `docs/postal-context-saint-vincent-grenadines-m2.md` and deterministic PNG/text receipts.
...
- Status: `blocked` / M2 unmet. Current government pages and the UPU confirm the `VGNNNN` system, so VG remains in postcode-data creation scope.
- Attempt: 1 from `2026-09-02T17:35:56.549Z`; completed `2026-09-02T17:52:11.3156710Z`.
- Definition: `M2_current_bvi_post_complete_typed_assignment_and_postal_area_visualization` requires a complete current typed assignment and area/non-area denominator, eligible real Polygon/MultiPolygon, compatible public-serving rights, separate postal/administrative/geometry/assertion/release/address/building/AGID IDs and actual API/app render/fit/clear/re-search.
- Primary evidence: seven exact BVI Government, UPU and NIQ/GfK bodies / 4,718,229 bytes are URL/status/byte/SHA-256 bound outside Git. Current government content demonstrates `VG1110`, `VG1140`, `VG1150` and `VG1160`; the UPU 02/2007 sheet confirms VG plus four digits. A retired official FAQ returns 404, so cached six-code text is not promoted as a current immutable denominator.
- Polygon quality and rights: the NIQ/GfK 2024 catalog advertises six four-digit postcode-area polygons, but no geometry bytes were purchased or accessed. Observed terms start at EUR 375, require a signed agreement and specify 12-month single-workstation in-house use; AGID redistribution/public-serving authority is not established. Zero official/derived/virtual areas, zero island/district/registration-section/office/P.O.-box/locality/address/building/administrative/point/buffer/hull/Voronoi/raster/AGID proxies and zero production records were promoted.
- Detailed IDs: future results must preserve separate postal assignment, postal object, geometry, administrative, assertion, release, civic-address, building and AGID crosswalk IDs. A postcode or National Addressing System label establishes no building relation. VG identity remains independent.
- App and visual boundary: the actual isolated app returned 200. Two `VG1110` searches generated four real `/api/v1/postal/VG/VG1110?geometry=geojson` requests, all 404 `Postal Context country is not supported`, and both showed the explicit no-inferred-polygon notice. One background map canvas remained and zero Polygon/MultiPolygon labels appeared. In-app Browser navigation failed on Windows ACL setup; deterministic Playwright exercised the real app path. Screenshot bitmap inspection also failed with Windows path error 206, so no human/live visual or translucent-area success is claimed.
- Verification: VG ledger/shared rollout/research catalog 15/15 and Americas source/shared research/API/store runtime 22/22 passed; JSON, evidence size/SHA-256 and diff checks passed. Full TypeScript was attempted but the linked dependency workspace lacks the local `@agid/addressql`, `@agid/contracts`, `@agid/core`, `@agid/country-data` and `@agid/studio` declarations, so a full type pass is not claimed.
- Evidence commit: `eeec74b5df90b0998ca1eac67426e266313d4807`; reports `reports/postal-context-m2/vg-source-review-2026-09-03.json`, `reports/postal-context-m2/vg-checks-2026-09-03.json`, `docs/postal-context-british-virgin-islands-m2.md` and the fixed PNG receipt.
- Retry: not before `2026-12-02T17:35:56.549Z` and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/NDA/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After VG: 252 profiles, 91 pending, 141 blocked, 0 in progress, 20 evidence-verified M2; 183 manifests / 173 explicit definitions; 23 non-synthetic research artifacts.
- Next country: U.S. Virgin Islands (`VI`). No second country was started.

## VI - U.S. Virgin Islands

- Status: `blocked` / M2 unmet. USPS Publication 28 confirms the current `VI` system and five-digit/ZIP+4 format; VI remains in postcode-data creation scope.
- Attempt: 1 from `2026-09-02T18:08:57.070Z`; completed `2026-09-02T18:35:00.000Z`.
- Definition: `M2_current_usps_vi_complete_typed_assignment_and_postal_area_runtime` requires a complete current typed USPS VI assignment and explicit area/non-area denominator, compatible rights, eligible real Polygon/MultiPolygon, separate postal/Census/geometry/assertion/release/address/building/AGID IDs and actual production API/app render/fit/clear/re-search.
- Primary evidence: nine exact USPS/Census bodies / 2,209,911 bytes are URL/retrieval/byte/SHA-256 bound outside Git. USPS describes the comprehensive City State Product as encrypted and non-exportable and requires other licensed products for complete five-digit coding; no compatible open AGID public-serving grant or licensed USPS row is claimed.
- Real data and polygon quality: the exact January 1, 2020 Census `008%` query supplies six coordinate-preserving derived ZCTAs (`00802`, `00820`, `00830`, `00840`, `00850`, `00851`), four Polygons plus two MultiPolygons, eight closed rings, no zero-area rings and 11,767 positions. Census states ZCTAs are generalized statistical representations, omit some valid ZIP Codes and can represent unique/P.O.-box codes; zero feature is labelled as a current USPS assignment or delivery boundary and zero surface is fabricated.
- Detailed ID linkage: every feature exposes Postal Context, geometry, Census GEOID/OID/OBJECTID, country assertion and release IDs. Five expose VI-prefixed AGID references. The `00830` internal point computes to `VG0ETQRJZKGQ`, so that crosswalk is withheld and surfaced as a mismatch rather than changing VI identity or merging territories.
- Application and visual boundary: the actual isolated app returned 200; the production VI postal API returned 404 `Postal Context country is not supported` and the loaded map shell exposed no VI postal controls. After catalog rebuild/restart, the actual research API returned 200 with status `blocked`, all six features and the separate sample postal/geometry/country/AGID IDs. In-app Browser and local bitmap inspection failed on Windows. Deterministic Playwright rendered/fitted the committed real `00802` surface with translucent fill and clear outline, detailed IDs, clear/re-search and `00830` mismatch handling; this is not claimed as production or human/live visual success.
- Verification: VI artifact/ID/authority 3/3, ledger/rollout/research Node 14/14 and research/API/Americas TypeScript 19/19 pass; canonical descriptor/graph/geometry/report rebuild hashes and diff checks pass. Typecheck has zero VI-specific errors but remains blocked by five unresolved local workspace package declarations. One broader address-format run has an unrelated existing VC source-registration failure.
- Evidence commit: `d281ee8288dd7440499fdc2d0f1bbbc13127c70a`; descriptor `sha256:d1efadf72034b513cd9611c156b84412c1938154ebfb4dae675153aea3f5b57c`, graph `sha256:c6834d5c347fdf25b54fd193ea238a5aa51d79f4e41c8becafea4c0d62bd746b`, geometry `sha256:8c8c7468dfbf07614a888ebb547caa24275985fac28d98ce7cbc26084294a6e4`.
- Reports: `reports/postal-context-m2/vi-zcta-validation-2026-09-03.json`, `reports/postal-context-m2/vi-engineering-validation-2026-09-03.json`, `reports/postal-context-m2/vi-browser-validation-2026-09-03.json`, fixed screenshots, and `docs/postal-context-us-virgin-islands-m2.md`.
- Retry: not before `2026-12-02T18:08:57.070Z` and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After VI: 252 profiles, 90 pending, 142 blocked, 0 in progress, 20 evidence-verified M2; 184 manifests / 174 explicit definitions; 24 non-synthetic research artifacts with 49,308 geometry features.
- Next country: Ascension Island (`AC`). No second country was started.

## AC - Ascension Island

- Result: `m2_verified` / `M2_current_upu_whole_territory_derived_visualization` at `2026-09-02T19:05:00.000Z`.
- Official postal evidence: the current UPU Universal POST*CODE DataBase August 2026 fixes `ASCN 1ZZ` as the single postcode for the whole territory. The UPU AC member record and current Ascension Island Government Post Office/2026 letterhead corroborate identity, operator and use. UPU/government bodies are reference-only and are not committed.
- Polygon and identity quality: fixed CC BY 4.0 geoBoundaries `SHN-ADM0-31036641` at commit `9469f09592ced973a3448cf66b6100b741b64c0d` is a geometry provenance container only. The transform selects Ascension source parts 44-46, preserves all 1,261 coordinates and `96.58210569103102 km²` exactly, and emits two independently Turf/JSTS-valid derived MultiPolygons. Saint Helena/Tristan da Cunha are excluded; SHN identity is not merged into AC; no official postal-boundary claim is made.
- Detailed ID linkage: `postal-ac-ascn-1zz` links through assertion `upu-ac-20260820-ascn-1zz-admin-within-ac` to `country-ac`; the UI exposes both geometry IDs, source/edition/date/licence/digest, quality `derived` / confidence `0.91`, release and manifest digest. No address, building, parcel, recipient, customer, delivery entitlement or land-right relation is inferred.
- Application and visual check: the isolated actual app reported AC ready and normalized full-width/compact inputs. Deterministic Playwright Chromium drove the real app, received three HTTP 200 responses from the live AC Postal Context API, mounted MapLibre, fitted the two real surfaces, displayed the translucent fill/clear outline and detailed evidence panel, cleared the layer and restored it on re-search. Only place-search discovery was stubbed. In-app Browser initialization failed on Windows ACL setup; fixed screenshots and deterministic checks are committed, but human manual visual inspection is not claimed.
...
- Status: `blocked` / M2 unmet. SCPT and UPU confirm the current numeric seven-digit system, so CD remains in postcode-data creation scope and reaches evidence-backed `M1_metadata` only.
- Attempt: 1 from `2026-09-02T23:01:02.073Z`; completed `2026-09-02T23:31:00.000Z`.
- Definition: `M2_current_scpt_seven_digit_assignment_and_postal_area_visualization` requires a current complete versioned seven-digit assignment with stable identities, aliases, validity, corrections, exceptions and explicit area/non-area denominator; compatible rights; exact real postal Polygon/MultiPolygon; separate postal/address/building/AGID identities; and actual API/app render, fit, clear and re-search.
- Primary evidence: 11 exact SCPT, UPU and ARPTC bodies / 4,063,260 bytes plus six candidate bodies / 330,701 bytes are URL/byte/SHA-256 bound outside Git. UPU edition 09/2022 confirms seven digits. Live SCPT rows validate `1004131` / row 175 / RESIDENTIEL / Limete / Kinshasa and `3202011` / row 1160 / BULUNGU / Bulungu / Kwilu, but do not form a versioned complete national denominator and expose no geometry.
- Polygon quality and rights: the exact RESIDENTIEL result is a Point; Limete supplies a broader administrative MultiPolygon; Bulungu supplies a Point plus an unrelated health Polygon. The deterministic quality gate rejects all three classes as postal areas. SCPT all-rights-reserved, UPU/database restrictions and the reviewed public bodies establish no compatible bulk AGID grant. Zero official/derived/virtual areas, zero Point/admin/route/facility/buffer/hull/Voronoi/raster/AGID proxies and zero production records were promoted.
- Hugging Face and OSS: `ellenhp/libpostal` revision `79e9bdd2145dcd2040e0bafea4596a49e0c2f70b` is under construction, has no Hub licence tag, no proven CD sample coverage and no geometry. It and upstream libpostal remain unpromoted offline parser/ranking evaluation candidates only; model output cannot create postal truth, rights or building identity.
- Detailed address and ID boundary: CD metadata now normalizes seven digits while preserving recipient, street/premises, neighbourhood, commune/territory, province, postal object, building and AGID IDs independently. The actual Limete search rendered a source-qualified Photon place and independent AGID `CD039MNVG8PJ`; neither is promoted to an SCPT postcode, postal surface or building relation.
- App and visual boundary: the isolated actual app returned 200; unmocked `GET /api/v1/postal/CD/1004131?geometry=geojson` returned 404 `Postal Context country is not supported`. Deterministic Playwright drove the real app path, selected the Limete result and observed two map canvases, but no postal-area notice or translucent postal overlay. In-app Browser initialization and local bitmap viewing failed at the Windows helper boundary, so no human visual or successful postcode-area E2E is claimed.
- Verification: fixed-source receipts 17/17, inspector units 3/3, CD postcode/geometry gate 3/3, app/API 2/2, deterministic browser 1/1, official catalog 59/59, shared area runtime 32/32, rollout 8/8 and scoped metadata/type/syntax/data 13/13 pass (138 recorded, 0 scoped failures). A broader unrelated pre-existing VC source-registration failure remains baseline-only.
- Evidence commit: `8906b8757d4cd7f59e4b38f8e91a3209ad225d02`; reports `reports/postal-context-m2/cd-source-review-2026-09-03.json`, `reports/postal-context-m2/cd-checks-2026-09-03.json` and `docs/postal-context-dr-congo-m2.md`.
...
- Status: `blocked` at `M1_metadata`; M2 unmet. Current postcode data creation is excluded because primary UPU evidence says Côte d'Ivoire does not require postal codes.
- Attempt: 1 from `2026-09-03T00:54:33.850Z`; completed `2026-09-03T01:15:22.264Z`.
- Definition: `M2_future_competent_authority_postcode_assignment_and_area_visualization` requires any future competent-authority system to publish a complete immutable assignment and area/non-area denominator, compatible rights, exact real postal Polygon/MultiPolygon, separate postal/address/building/AGID identities and actual API/app render, fit, clear and re-search.
- Evidence: three exact UPU bodies / 818,237 bytes are URL/byte/SHA-256 bound outside Git. The UPU September 2025 no-postcode list in the file updated August 2026 explicitly includes Côte d'Ivoire. The UPU 09/2004 sheet defines `06` and `17` as post-office codes, `104` as home delivery by office 04 and `BP` as a P.O.-box delivery object; none is a national postcode. ARTCI's current operator record corroborates La Poste and the `17 BP 105 Abidjan 17` form, but its exact body could not be retrieved and is not counted in the digest-bound set.
- Address, polygon and model quality: the false five-digit AGID metadata was removed. Zero official/derived/virtual postal Polygon/MultiPolygon records exist. The deterministic gate rejects arbitrary digits, office codes, home-delivery indicators, BP objects, foreign assignments, Point/route/office/admin geometry, buffers, hulls, Voronoi/raster cells, draft planning cells, AGID cells and Hugging Face/libpostal output as postal truth. OSM remains separate source-qualified context; no proxy was promoted.
- Detailed address and ID boundary: the live Photon result displayed `Bibliothèque nationale de Côte d'Ivoire, Boulevard Carde, Le Plateau, Abidjan` and independent AGID `CI01ZMYVT7E8`. The result is marked ambiguous / needs review and is not promoted to a postcode, postal surface or authoritative building relation; more detailed buildings require independent rights-cleared identity and geometry evidence.
- App and visual boundary: the isolated actual app returned 200; unmocked `GET /api/v1/postal/CI/06?geometry=geojson` returned 404 `Postal Context country is not supported`. Deterministic Playwright selected the detailed result and observed two map canvases with no postal-area notice or fake translucent overlay. In-app Browser initialization and local bitmap viewing failed at Windows helper boundaries, so human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact source 3/3, inspector units 3/3, address metadata 2/2, CI/source/catalog 61/61, shared area/API runtime 29/29, rollout 8/8, deterministic browser 1/1, research/API/pack/routes/service/OpenAPI 56/56, research determinism 2/2, typecheck and diff checks pass (166 recorded, 0 failed).
- Evidence commit: `056ad9b815ea9d8526e5cd6520642442c4af58f0`; reports `reports/postal-context-m2/ci-source-review-2026-09-03.json`, `reports/postal-context-m2/ci-checks-2026-09-03.json` and `docs/postal-context-cote-divoire-m2.md`.
- Retry: not before `2026-12-03T00:54:33.850Z` and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After CI: 252 profiles, 80 pending, 151 blocked, 0 in progress, 21 evidence-verified M2; 194 manifests / 184 explicit definitions; 25 non-synthetic research artifacts with 49,310 geometry features.
- Next country: Cameroon (`CM`). No second country was started.

## CM - Cameroon

- Status: blocked at M1_metadata; M2 unmet. Current postcode data creation is excluded because primary UPU evidence says Cameroon does not require postal codes.
- Attempt: 1 from 2026-09-03T01:38:04.222Z; completed 2026-09-03T01:59:56.115Z.
- Definition: M2_future_competent_authority_postcode_assignment_and_area_visualization requires any future competent-authority system to publish a complete immutable assignment and area/non-area denominator, compatible rights, exact real postal Polygon/MultiPolygon, separate postal/address/building/AGID identities and actual API/app render, fit, clear and re-search.
- Evidence: five exact UPU, MINPOSTEL and MINESUP bodies / 938,084 bytes are URL/byte/SHA-256 bound outside Git. The UPU September 2025 no-postcode list in the file updated August 2026 explicitly includes Cameroon. The UPU 07/2002 example is BP 6000 / YAOUNDE. MINESUP labels 54190 and 1739 as BP/address-postale identifiers. MINPOSTEL identifies Campost and 42 authorized private operators but publishes no postcode denominator or geometry.
- Address, polygon and model quality: the false five-digit English shipping rule was corrected to not-used. Zero official/derived/virtual postal Polygon/MultiPolygon records exist. The deterministic gate rejects arbitrary digits, numeric BP objects, foreign assignments, Point/route/office/admin geometry, buffers, hulls, Voronoi/raster cells, draft planning cells, AGID cells and Hugging Face/libpostal output as postal truth. OSM remains separate source-qualified context; no proxy was promoted.
- Detailed address and ID boundary: the live Photon result displayed GCM3T yaounde Cameroon, Rue 7.082, Étoug-ébé, Yaoundé, Centre, Cameroun and independent AGID CM0224YJ5QS9. The result is marked ambiguous and is not promoted to a postcode, postal surface or authoritative building relation; more detailed buildings require independent rights-cleared identity and geometry evidence.
- App and visual boundary: the isolated actual app returned 200; unmocked GET /api/v1/postal/CM/54190?geometry=geojson returned 404 Postal Context country is not supported. Deterministic Playwright selected the detailed result and observed two map canvases with no postal-area notice or fake translucent overlay. In-app Browser initialization and local bitmap viewing failed at Windows helper boundaries, so human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact sources 5/5, inspector units 3/3, address metadata 2/2, CM/source/catalog 61/61, shared area/API runtime 38/38, rollout/reference 9/9, deterministic browser 1/1, research/API/pack/routes/service/OpenAPI 56/56, research determinism 2/2, typecheck and diff checks pass (178 recorded, 0 failed).
- Evidence commit: 043b1f0f79222939821aca375bc4c75084cce949; reports reports/postal-context-m2/cm-source-review-2026-09-03.json, reports/postal-context-m2/cm-checks-2026-09-03.json and docs/postal-context-cameroon-m2.md.
- Retry: not before 2026-12-03T01:38:04.222Z and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After CM: 252 profiles, 79 pending, 152 blocked, 0 in progress, 21 evidence-verified M2; 195 manifests / 185 explicit definitions; 25 non-synthetic research artifacts with 49,310 geometry features.
- Next country: Cabo Verde (CV). No second country was started.

## CV - Cabo Verde

- Status: blocked at M1_metadata; M2 unmet. A current four-digit postcode system is confirmed, so CV remains a postcode-data target, but no complete rights-cleared assignment denominator or postal Polygon/MultiPolygon artifact was identified.
- Attempt: 1 from 2026-09-03T02:16:05.886Z; completed 2026-09-03T02:46:00.000Z.
- Definition: M2_current_correios_assignment_and_postal_area_visualization requires every current Correios four-digit assignment, alias, validity, correction, exception and area/non-area object to be fixed by edition, bytes and SHA-256 under compatible rights, reconciled to exact real postal Polygon/MultiPolygon geometry, and exercised through the actual API/app render, fit, clear and re-search path.
- Primary evidence: eight exact Correios, UPU and INGT bodies / 1,429,576 bytes are URL/byte/SHA-256 bound outside Git. Correios documents current examples 7600 Plateau, 7601 Fazenda and 7602 Achada Santo Antonio; the UPU August 2026 table confirms four digits and its 04/2014 sheet documents the coding hierarchy. Three examples do not establish a complete current denominator.
- Identifier, privacy and rights boundary: 35 NNNN-NNN contact-page occurrences / 32 unique values remain separate typed operator contact identifiers; authenticated CIP remains a private person/company postal-domicile identity. No CIP row, authentication, registration, terms acceptance, provider contact or payment occurred. Correios all-rights-reserved, CIP restrictions, UPU database rights and INGT ownership do not establish an open AGID processing, derivation, redistribution and public-serving grant.
- Polygon, OSS and model quality: INGT island, municipality, parish, zone, city, town, locality and neighbourhood Polygon layers are administrative/toponymic context rather than postal areas. The deterministic gate rejects them, along with branch/CIP Points, OSM, buffers, hulls, Voronoi/raster cells, AGID cells and Hugging Face/model output, as postal truth. OSS remains useful for parsing, candidate ranking, topology QA and compression only after authority and rights exist. Zero official/derived/virtual postal areas and zero production records were promoted.
- Detailed address and ID boundary: the live Photon search selected Universidade de Cabo Verde / Palmarejo Grande / Praia and the app rendered detailed non-postal context En3-St-05, 5298 Praia with independent AGID CV014TVAYWAK. The result is ambiguous / needs review and is not promoted to a postcode, postal polygon or authoritative building relation.
- App and visual boundary: the isolated actual app returned 200; unmocked GET /api/v1/postal/CV/7600?geometry=geojson returned 503 Postal Context pack is unavailable. Deterministic Playwright observed two map canvases, no postal-area notice and no fake translucent overlay. In-app Browser and local bitmap viewing failed at Windows helper boundaries, so human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact source receipts 8/8, inspector units 3/3, address metadata 2/2, CV/source/runtime/catalog 77/77, shared UI/API/geometry 57/57, research determinism 2/2, rollout 8/8, deterministic browser 1/1 and typecheck pass (159 scoped checks, 0 failed). Two unrelated pre-existing global address-format failures remain baseline-only.
- Evidence commit: 274e80c66fcb36a60d92dc9adbf187c0cb45e980; reports reports/postal-context-m2/cv-source-review-2026-09-03.json, reports/postal-context-m2/cv-checks-2026-09-03.json and docs/postal-context-cabo-verde-m2.md.
- Retry: not before 2026-12-03T02:16:05.886Z and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After CV: 252 profiles, 78 pending, 153 blocked, 0 in progress, 21 evidence-verified M2; 195 manifests / 186 explicit definitions; 25 non-synthetic research artifacts with 49,310 geometry features.
- Next country: Djibouti (DJ). No second country was started.

## DJ - Djibouti

- Status: blocked at M1_metadata; M2 unmet. A current five-digit postcode system is confirmed, so DJ remains a postcode-data target, but no complete current rights-cleared assignment denominator or postal Polygon/MultiPolygon artifact was identified.
- Attempt: 1 from 2026-09-03T02:56:06.364Z; completed 2026-09-03T03:25:00.000Z.
- Definition: M2_current_laposte_five_digit_assignment_and_postal_area_visualization requires every current La Poste five-digit assignment, alias, locality, region, office, validity, correction, exception and area/non-area object to be fixed by edition, bytes and SHA-256 under compatible rights, reconciled to exact real postal Polygon/MultiPolygon and exercised through the actual DJ API/app states, fit, translucent fill/outline, clear and re-search.
- Primary evidence: nine exact UPU and Djibouti-government bodies / 8,796,563 bytes are URL/byte/SHA-256 bound outside Git. The UPU 05/2020 sheet supplies ten dated reference rows and country/region/post-office digit semantics; the August 2026 table confirms numeric 99999. The rows are not a proven complete 2026 denominator.
- Rights and access: the UPU public Africa sample ZIP contains no Djibouti files. The current world database 2026.1 is subject to a licence contract, NDA, data-use declaration and rates. No provider contact, registration, authentication, terms/licence/NDA/contract acceptance or payment occurred, and no compatible AGID public-serving rights were inferred.
- Polygon, OSS and model quality: zero official/derived/virtual postal Polygon/MultiPolygon and zero production records were promoted. The deterministic gate rejects administrative maps, post-office points, roads, address/building features, buffers, hulls, Voronoi/raster surfaces, OSM, Hugging Face/model output and AGID cells as postal truth. OSS remains useful for normalization, parsing, ranking, topology QA and compression only after authority and rights exist.
- Detailed address and ID boundary: the live Photon search selected La Poste de Djibouti / Rue de Mohamed Doura / Le Plateau du Marabout and rendered independent AGID DJ02RHS2MYNN with two map canvases. It is high but ambiguous/needs-review and is not promoted to an authoritative building, postcode or postal area; exact building detail requires a separate explicit rights-cleared relation.
- App and visual boundary: the isolated actual app returned 200; unmocked GET /api/v1/postal/DJ/77101?geometry=geojson returned 404 Postal Context country is not supported, and no postal-area notice or fake translucent overlay rendered. In-app Browser and local image viewing failed at Windows helper boundaries; deterministic Playwright passed, but human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact source receipts 9/9, address metadata 2/2, DJ/source/repository/catalog 64/64, research/rollout 10/10, shared runtime/API/UI/geometry 92/92, deterministic browser 1/1, typecheck, JSON and diff checks pass (171 recorded, 0 failed).
- Evidence commit: 39ad0f07441ba22e1f03ce034b4665c33f060274; reports reports/postal-context-m2/dj-source-review-2026-09-03.json, reports/postal-context-m2/dj-checks-2026-09-03.json and docs/postal-context-djibouti-m2.md.
- Retry: not before 2026-12-03T02:56:06.364Z and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/NDA/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After DJ: 252 profiles, 77 pending, 154 blocked, 0 in progress, 21 evidence-verified M2; 196 manifests / 187 explicit definitions; 25 non-synthetic research artifacts with 49,310 geometry features.
- Next country: Algeria (DZ). No second country was started.

## DZ - Algeria

- Status: blocked at M1_metadata; M2 unmet. UPU August 2026 confirms Algeria currently uses numeric five-digit postcodes, so DZ remains a postcode-data target, but no complete current rights-cleared assignment denominator or postal Polygon/MultiPolygon artifact was identified.
- Attempt: 1 from 2026-09-03T03:31:06.887Z; completed 2026-09-03T04:07:14.792Z.
- Definition: M2_current_algerie_poste_five_digit_assignments_and_postal_area_visualization requires every current Algérie Poste assignment, alias, validity, correction, exception and explicit area/non-area postal object to be fixed by edition, bytes and SHA-256 under compatible rights, reconciled to exact real postal Polygon/MultiPolygon geometry, and exercised through actual DZ API/app states, fit, translucent fill/outline, clear and re-search.
- Primary evidence: five exact UPU and Algerian-government bodies / 1,151,046 bytes are URL/byte/SHA-256 bound outside Git. The UPU 07/2002 sheet supplies historical delivery-area/wilaya context; the August 2026 table confirms current numeric 99999. Executive Decree 19-258 says Algérie Poste exclusively determines postcodes. Public fixed/mobile directory examples, blank-code rows and FAQ lookup guidance do not form a complete versioned national denominator.
- Rights, polygon and model quality: the reviewed public pages and UPU publication terms establish no compatible bulk AGID grant. Zero official/derived/virtual postal Polygon/MultiPolygon and zero production records were promoted. The deterministic gate rejects fixed/mobile establishments, office/address points, routes, P.O. boxes, organizations, commune/daïra/wilaya or INCT geometry, buffers, hulls, Voronoi/raster cells, OSM, Hugging Face/model output and AGID cells as postal truth. OSS remains useful for normalization, multilingual parsing evaluation, ranking, topology QA, drift detection and bounded-error compression only after authority and rights exist.
- Detailed address and ID boundary: the actual app selected Bureau d'Algérie Poste de l'USTHB / BP 32 / Boulevard de l'Université / Bab Ezzouar / Algiers / 16111 from OSM via Photon and rendered independent AGID DZ02A83TH4JX with two map canvases. It is high but ambiguous/needs-review and is not promoted to an authoritative postcode area or exact building; building detail requires an independent explicit rights-cleared relation.
- App and visual boundary: the isolated actual app returned 200; unmocked GET /api/v1/postal/DZ/16024?geometry=geojson returned 503 Postal Context pack is unavailable, and no postal-area notice or fake translucent overlay rendered. In-app Browser and local image viewing failed at Windows helper boundaries. Deterministic Playwright passed, but human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact source receipts 5/5, DZ quality/repository/runtime/API/source 76/76, shared runtime/API/UI/geometry 107/107, research determinism 2/2, deterministic browser 1/1, typecheck and diff checks pass at the evidence stage (188 recorded, 0 scoped failures); final ledger/rollout/link checks add 12/12 passes. Two unrelated pre-existing global address-format failures remain baseline-only.
- Evidence commit: f920b3595e4c8fb994790e69950faad3b5d52870; reports reports/postal-context-m2/dz-source-review-2026-09-03.json, reports/postal-context-m2/dz-checks-2026-09-03.json and docs/postal-context-algeria-m2.md.
- Retry: not before 2026-12-03T03:31:06.887Z and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/NDA/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After DZ: 252 profiles, 76 pending, 155 blocked, 0 in progress, 21 evidence-verified M2; 196 manifests / 187 explicit definitions; 25 non-synthetic research artifacts with 49,310 geometry features.
- Next country: Ceuta and Melilla (EA). No second country was started; EA remains a distinct source identity and is traversed in Africa per the canonical ledger.

## EA - Ceuta and Melilla

- Status: blocked at M1_metadata; M2 unmet. The current Correos system uses 51xxx for Ceuta and 52xxx for Melilla, but no complete current rights-cleared assignment denominator or redistributable exact postal Polygon/MultiPolygon artifact was identified.
- Attempt: 1 from 2026-09-03T04:20:37.745Z; completed 2026-09-03T05:03:58.322Z.
- Identity and definition: the canonical ledger keeps the existing EA identity, Africa traversal and Europe source path. The source registry's Ceuta and Melilla members remain distinct and are not merged into one territory or absorbed into ES, IC, PT or Morocco. M2_current_correos_ea_assignments_and_postal_area_visualization requires every current 51xxx/52xxx assignment, alias, validity, correction, exception and explicit area/non-area object under compatible rights, exact same-code surfaces and actual EA API/app rendering.
- Primary evidence: nine exact CartoCiudad, Correos, datos.gob.es and European Commission bodies / 514,425 bytes are URL/byte/SHA-256 bound outside Git. CartoCiudad documents annual generation with Grupo Correos. The WMS 1.3.0 view returned codigo-postal.510010000005 for 51001 as a one-ring closed Polygon with 184 positions, bbox [-5.33371012, 35.88421039, -5.2965182, 35.89902507], database time 2026-01-13T13:14:47Z and source date 20260112.
- Rights, polygon and model quality: CartoCiudad says postcode surfaces are visualization-only and not downloadable; CNIG identifies Correos as sole distributor, while Correos Data is commercial and restricts transfer, sublicensing and similar Internet finder use. The real Polygon passed NFKC, member-prefix, finite WGS84, closure, minimum-position, duplicate, zero-edge, self-intersection and territory-bbox checks, but remains one official-view sample and zero production records. Points, administrative outlines, buffers, hulls, Voronoi/raster cells, OSM, Hugging Face/model output and AGID cells were not promoted. OSS/model use remains limited to parsing evaluation, ranking, anomaly review, drift detection and bounded-error compression after authority and rights gates.
- Detailed address and ID boundary: the actual app selected Ceuta Center / Paseo de Colón / Manzanera - Otero / Ceuta / España from OSM via Photon and rendered independent AGID EA01NSDT6T2S with two map canvases. It is high but ambiguous/needs-review and is not a postcode polygon or exact building; more-specific building display still requires an independent explicit rights-cleared address/building relation.
- App and visual boundary: the isolated actual app returned 200; unmocked GET /api/v1/postal/EA/51001?geometry=geojson returned 503 Postal Context pack is unavailable, and no postal-area notice or fake translucent overlay rendered. In-app Browser and local image viewing failed at Windows helper boundaries. Deterministic Playwright passed, but human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact source receipts 9/9, EA quality/policy/repository/API/source 68/68, shared runtime/API/UI/geometry 63/63, deterministic browser 1/1, typecheck and diff checks pass at the evidence stage (134 recorded, 0 scoped failures); immutable ledger-link, research-catalog, status and final rollout checks pass separately. Two unrelated pre-existing global address-format failures remain baseline-only.
- Evidence commit: 195f06823f0cfac01c8bedbc1358a625badc7d34; reports reports/postal-context-m2/ea-source-review-2026-09-03.json, reports/postal-context-m2/ea-browser-2026-09-03.json, reports/postal-context-m2/ea-checks-2026-09-03.json and docs/postal-context-ceuta-melilla-m2.md.
- Retry: not before 2026-12-03T04:20:37.745Z and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/NDA/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After EA: 252 profiles, 75 pending, 156 blocked, 0 in progress, 21 evidence-verified M2; 197 manifests / 188 explicit definitions; 25 non-synthetic research artifacts with 49,310 geometry features.
- Next country: Egypt (EG). No second country was started.

## EG - Egypt

- Status: blocked at M1_metadata; M2 unmet. UPU Universal DataBase Aug. 2026 confirms a current postcode requirement but records both `99999` and `9999999`; no complete current rights-cleared assignment/migration denominator or official postal Polygon/MultiPolygon artifact was identified.
- Attempt: 1 from 2026-09-03T05:17:08.762Z; completed 2026-09-03T05:38:17.6754861Z.
- Definition: M2_current_egypt_post_assignments_migration_and_postal_area_visualization requires every current Egypt Post five/seven-digit assignment, migration, alias, validity, correction, exception and explicit area/non-area object under compatible rights, exact same-code surfaces and actual EG API/app states, fit, translucent fill/outline, metadata, clear and re-search.
- Primary evidence: five exact UPU/Egypt Post bodies / 3,278,046 bytes are URL/byte/SHA-256 bound outside Git. The UPU 07/2023 Egypt sheet defines province (2), locality (1), neighbourhood (2) and community (2); the Egypt Post GIS guide documents GPS/address lookup; neither supplies complete reusable national rows, a migration crosswalk or postal surfaces.
- Rights, polygon and model quality: zero official/derived/virtual postal Polygon/MultiPolygon and zero production records were promoted. Postal points/offices, CAPMAS or Survey administration, building clusters, buffers, hulls, Voronoi, OSM, Hugging Face/model output and AGID cells remain separate. OSS/model use is limited to Arabic/Latin parsing evaluation, ranking, topology QA and drift detection after authority and rights gates.
- Detailed address and ID boundary: the actual app searched `12611` with country filter `eg`, selected ambiguous OSM/Photon `12611 Aj Jiza, Egypt`, and rendered `شارع حسن رمضان, الجيزة, 12611` with independent AGID `EG02KW1BKHN9`. This is more detailed context, not an authoritative postal area or exact building relation.
- App and visual boundary: the isolated actual app returned 200; unmocked `GET /api/v1/postal/EG/3759914?geometry=geojson` returned 503 `Postal Context pack is unavailable`; the UI rendered `Postal area unavailable` and no inferred overlay. In-app Browser and local image viewing failed at Windows helper boundaries. Deterministic Playwright verified two map canvases and two nonblank 1440×1100 captures; human visual inspection and successful postcode-area E2E are not claimed.
- Verification: exact source receipts 5/5, EG source/policy/repository/runtime/API and shared UI/geometry 85/85, typecheck and diff checks pass. Three unrelated pre-existing global address-format failures (EA, CI, VC) remain baseline-only and were not changed during the EG-only run.
- Evidence commit: 073c74f2adebbd224752f885e7d8f2b9cbe59e2c; reports `reports/postal-context-m2/eg-source-review-2026-09-03.json` and `docs/postal-context-egypt-m2.md`.
- Retry: not before 2026-12-03T05:17:08.762Z and only after pending countries are swept; provider contact, data request, registration, authentication, terms/licence/NDA/contract acceptance, payment, protected-data access, destination creation, publication or deployment requires explicit approval.
- After EG: 252 profiles, 74 pending, 157 blocked, 0 in progress, 21 evidence-verified M2; 197 manifests / 188 explicit definitions.
- Loop control: the user requested that the automation stop after EG. Western Sahara (EH) remains the next pending country if the sweep is resumed; no EH work was started.
