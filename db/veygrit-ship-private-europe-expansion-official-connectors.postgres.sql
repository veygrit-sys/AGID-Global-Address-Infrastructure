-- Add five direct private European carrier adapters.
-- Re-runnable after the private Asia expansion migration.
...
ALTER TABLE veygrit_ship_shipment
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_yodel_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_fan_courier_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_acs_courier_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_dachser_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_sameday_adapter_chk;

ALTER TABLE veygrit_ship_carrier_connection
  ADD CONSTRAINT veygrit_ship_connection_carrier_private_europe_expansion_chk
  CHECK (carrier IN (
...
ALTER TABLE veygrit_ship_shipment
  ADD CONSTRAINT veygrit_ship_shipment_carrier_private_europe_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
  ...
  ADD CONSTRAINT veygrit_ship_shipment_adapter_private_europe_expansion_chk
    CHECK (adapter IN (
  ...
  ADD CONSTRAINT veygrit_ship_shipment_yodel_adapter_chk
    CHECK (carrier <> 'yodel' OR adapter IS NULL OR adapter = 'yodel-shipping-orders-v1'),
  ADD CONSTRAINT veygrit_ship_shipment_fan_courier_adapter_chk
    CHECK (carrier <> 'fan_courier' OR adapter IS NULL OR adapter = 'fan-courier-api-v2'),
  ADD CONSTRAINT veygrit_ship_shipment_acs_courier_adapter_chk
    CHECK (carrier <> 'acs_courier' OR adapter IS NULL OR adapter = 'acs-rest-web-services-v1'),
  ADD CONSTRAINT veygrit_ship_shipment_dachser_adapter_chk
    CHECK (carrier <> 'dachser' OR adapter IS NULL OR adapter = 'dachser-business-integration-v2'),
  ADD CONSTRAINT veygrit_ship_shipment_sameday_adapter_chk
    CHECK (carrier <> 'sameday' OR adapter IS NULL OR adapter = 'sameday-client-api-v2');

ALTER TABLE veygrit_ship_rate_quote
  ADD CONSTRAINT veygrit_ship_rate_quote_carrier_private_europe_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
  ...
  ADD CONSTRAINT veygrit_ship_rate_quote_adapter_private_europe_expansion_chk
    CHECK (adapter IN (
      'ups', 'mydhl-express', 'ecommerce-americas-v4', 'amazon-shipping-v2',
      'loggi-v1', 'royal-mail-shipping-v2', 'inpost-shipping-v2',
      'ninja-van-order-v4.2', 'delhivery-b2c-v1', 'pargo-simba-v1',
...
ALTER TABLE veygrit_ship_label
  ADD CONSTRAINT veygrit_ship_label_carrier_private_europe_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
...
ALTER TABLE veygrit_ship_tracking_event
  ADD CONSTRAINT veygrit_ship_tracking_carrier_private_europe_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
