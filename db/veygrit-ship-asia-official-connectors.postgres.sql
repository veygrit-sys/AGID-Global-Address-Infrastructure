-- Add direct Ninja Van and Delhivery carrier persistence.
-- Re-runnable after the core, Americas, and Europe carrier migrations.
...
ALTER TABLE veygrit_ship_carrier_connection
  ADD CONSTRAINT veygrit_ship_connection_carrier_asia_chk
  CHECK (carrier IN ('ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van', 'delhivery'));

ALTER TABLE veygrit_ship_shipment
  ADD CONSTRAINT veygrit_ship_shipment_carrier_asia_chk
    CHECK (carrier IN ('ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van', 'delhivery')),
  ADD CONSTRAINT veygrit_ship_shipment_adapter_asia_chk
    CHECK (adapter IN ('ups', 'mydhl-express', 'ecommerce-americas-v4', 'amazon-shipping-v2', 'loggi-v1', 'royal-mail-shipping-v2', 'inpost-shipping-v2', 'ninja-van-order-v4.2', 'delhivery-b2c-v1')),
...
ALTER TABLE veygrit_ship_rate_quote
  ADD CONSTRAINT veygrit_ship_rate_quote_carrier_asia_chk
    CHECK (carrier IN ('ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van', 'delhivery')),
  ADD CONSTRAINT veygrit_ship_rate_quote_adapter_asia_chk
    CHECK (adapter IN ('ups', 'mydhl-express', 'ecommerce-americas-v4', 'amazon-shipping-v2', 'loggi-v1', 'royal-mail-shipping-v2', 'inpost-shipping-v2', 'ninja-van-order-v4.2', 'delhivery-b2c-v1'));

ALTER TABLE veygrit_ship_label
  ADD CONSTRAINT veygrit_ship_label_carrier_asia_chk
  CHECK (carrier IN ('ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van', 'delhivery'));

ALTER TABLE veygrit_ship_tracking_event
  ADD CONSTRAINT veygrit_ship_tracking_event_carrier_asia_chk
  CHECK (carrier IN ('ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van', 'delhivery'));
