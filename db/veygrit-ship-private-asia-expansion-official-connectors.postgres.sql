-- Add four direct private Asian carrier adapters.
-- Re-runnable after the MENA expansion migration.
...
ALTER TABLE veygrit_ship_shipment
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_blue_dart_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_dtdc_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_gdex_adapter_chk,
  DROP CONSTRAINT IF EXISTS veygrit_ship_shipment_jne_adapter_chk;

ALTER TABLE veygrit_ship_carrier_connection
  ADD CONSTRAINT veygrit_ship_connection_carrier_private_asia_expansion_chk
  CHECK (carrier IN (
...
ALTER TABLE veygrit_ship_shipment
  ADD CONSTRAINT veygrit_ship_shipment_carrier_private_asia_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
  ...
  ADD CONSTRAINT veygrit_ship_shipment_adapter_private_asia_expansion_chk
    CHECK (adapter IN (
  ...
  ADD CONSTRAINT veygrit_ship_shipment_blue_dart_adapter_chk
    CHECK (carrier <> 'blue_dart' OR adapter IS NULL OR adapter = 'blue-dart-business-integration-v1'),
  ADD CONSTRAINT veygrit_ship_shipment_dtdc_adapter_chk
    CHECK (carrier <> 'dtdc' OR adapter IS NULL OR adapter = 'dtdc-enterprise-v1'),
  ADD CONSTRAINT veygrit_ship_shipment_gdex_adapter_chk
    CHECK (carrier <> 'gdex' OR adapter IS NULL OR adapter = 'mygdex-openapi-v1'),
  ADD CONSTRAINT veygrit_ship_shipment_jne_adapter_chk
    CHECK (carrier <> 'jne' OR adapter IS NULL OR adapter = 'jne-contract-api-v1');

ALTER TABLE veygrit_ship_rate_quote
  ADD CONSTRAINT veygrit_ship_rate_quote_carrier_private_asia_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
  ...
  ADD CONSTRAINT veygrit_ship_rate_quote_adapter_private_asia_expansion_chk
    CHECK (adapter IN (
      'ups', 'mydhl-express', 'ecommerce-americas-v4', 'amazon-shipping-v2',
      'loggi-v1', 'royal-mail-shipping-v2', 'inpost-shipping-v2',
      'ninja-van-order-v4.2', 'delhivery-b2c-v1', 'pargo-simba-v1',
...
ALTER TABLE veygrit_ship_label
  ADD CONSTRAINT veygrit_ship_label_carrier_private_asia_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
...
ALTER TABLE veygrit_ship_tracking_event
  ADD CONSTRAINT veygrit_ship_tracking_carrier_private_asia_expansion_chk
    CHECK (carrier IN (
      'ups', 'dhl', 'amazon_shipping', 'loggi', 'royal_mail', 'inpost', 'ninja_van',
      'delhivery', 'pargo', 'courier_guy', 'sf_express', 'four_px', 'chilexpress',
      'coordinadora', 'oca', 'ninety_nine_minutos', 'redpack', 'estafeta', 'jadlog',
