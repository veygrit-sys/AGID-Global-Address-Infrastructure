...
```text
dawnportinfo-design/agid-open-cn-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-cn-gazetteer --public --description "AGID source-linked gazetteer seed for China"
git init
git add .
git commit -m "Seed CN AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-cn-gazetteer.git
