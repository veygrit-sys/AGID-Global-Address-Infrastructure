...
```text
dawnportinfo-design/agid-open-trnc-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-trnc-gazetteer --public --description "AGID source-linked gazetteer seed for Northern Cyprus"
git init
git add .
git commit -m "Seed TRNC AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-trnc-gazetteer.git
