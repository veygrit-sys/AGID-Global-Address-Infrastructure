...
```text
dawnportinfo-design/agid-open-ie-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-ie-gazetteer --public --description "AGID source-linked gazetteer seed for Ireland"
git init
git add .
git commit -m "Seed IE AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-ie-gazetteer.git
