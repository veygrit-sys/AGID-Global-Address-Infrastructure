...
```text
dawnportinfo-design/agid-open-pn-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-pn-gazetteer --public --description "AGID source-linked gazetteer seed for Pitcairn Islands"
git init
git add .
git commit -m "Seed PN AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-pn-gazetteer.git
