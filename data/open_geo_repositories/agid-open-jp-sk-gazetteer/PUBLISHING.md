...
```powershell
gh repo create dawnportinfo-design/agid-open-jp-sk-gazetteer --public --description "AGID source-linked gazetteer seed for Senkaku Islands"
git init
git add .
git commit -m "Seed JP_SK AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-jp-sk-gazetteer.git
