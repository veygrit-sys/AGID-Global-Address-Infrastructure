...
```text
dawnportinfo-design/agid-open-bn-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-bn-gazetteer --public --description "AGID source-linked gazetteer seed for Brunei"
git init
git add .
git commit -m "Seed BN AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-bn-gazetteer.git
