...
```text
dawnportinfo-design/agid-open-kash-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-kash-gazetteer --public --description "AGID source-linked gazetteer seed for Kashmir"
git init
git add .
git commit -m "Seed KASH AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-kash-gazetteer.git
