...
```text
dawnportinfo-design/agid-open-my-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-my-gazetteer --public --description "AGID source-linked gazetteer seed for Malaysia"
git init
git add .
git commit -m "Seed MY AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-my-gazetteer.git
