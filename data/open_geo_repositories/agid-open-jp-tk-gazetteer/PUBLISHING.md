...
```text
dawnportinfo-design/agid-open-jp-tk-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-jp-tk-gazetteer --public --description "AGID source-linked gazetteer seed for Takeshima / Dokdo"
git init
git add .
git commit -m "Seed JP_TK AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-jp-tk-gazetteer.git
