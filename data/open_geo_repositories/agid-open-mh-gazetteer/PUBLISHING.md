...
```powershell
gh repo create dawnportinfo-design/agid-open-mh-gazetteer --public --description "AGID source-linked gazetteer seed for Marshall Islands"
git init
git add .
git commit -m "Seed MH AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-mh-gazetteer.git
