...
```powershell
gh repo create dawnportinfo-design/agid-open-cp-gazetteer --public --description "AGID source-linked gazetteer seed for Clipperton Island"
git init
git add .
git commit -m "Seed CP AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-cp-gazetteer.git
