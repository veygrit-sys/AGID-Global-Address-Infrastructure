...
```powershell
gh repo create dawnportinfo-design/agid-open-jp-nt-gazetteer --public --description "AGID source-linked gazetteer seed for Northern Territories"
git init
git add .
git commit -m "Seed JP_NT AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-jp-nt-gazetteer.git
