...
```powershell
gh repo create dawnportinfo-design/agid-open-baar-gazetteer --public --description "AGID source-linked gazetteer seed for Baarle Enclaves"
git init
git add .
git commit -m "Seed BAAR AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-baar-gazetteer.git
