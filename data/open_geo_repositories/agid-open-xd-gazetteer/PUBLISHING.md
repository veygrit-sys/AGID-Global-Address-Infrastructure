...
```powershell
gh repo create dawnportinfo-design/agid-open-xd-gazetteer --public --description "AGID source-linked gazetteer seed for Dhekelia"
git init
git add .
git commit -m "Seed XD AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-xd-gazetteer.git
