...
```text
dawnportinfo-design/agid-open-fm-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-fm-gazetteer --public --description "AGID source-linked gazetteer seed for Micronesia"
git init
git add .
git commit -m "Seed FM AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-fm-gazetteer.git
