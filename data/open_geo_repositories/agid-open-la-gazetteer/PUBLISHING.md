...
```text
dawnportinfo-design/agid-open-la-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-la-gazetteer --public --description "AGID source-linked gazetteer seed for Laos"
git init
git add .
git commit -m "Seed LA AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-la-gazetteer.git
