...
```powershell
gh repo create dawnportinfo-design/agid-open-vn-gazetteer --public --description "AGID source-linked gazetteer seed for Vietnam"
git init
git add .
git commit -m "Seed VN AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-vn-gazetteer.git
