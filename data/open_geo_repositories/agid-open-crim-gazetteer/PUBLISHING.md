...
```powershell
gh repo create dawnportinfo-design/agid-open-crim-gazetteer --public --description "AGID source-linked gazetteer seed for Crimea"
git init
git add .
git commit -m "Seed CRIM AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-crim-gazetteer.git
