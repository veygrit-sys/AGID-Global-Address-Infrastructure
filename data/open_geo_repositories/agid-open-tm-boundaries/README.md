# agid-open-tm-boundaries

Turkmenistan (TM) P1 high AGID open-geodata recovery seed.
...
- Country or region code: `TM`
- Recovery track: `address-only-recovery`
- Present local core role: `address`
- Missing core roles: `geocoding`, `admin-boundary`, `gazetteer`
