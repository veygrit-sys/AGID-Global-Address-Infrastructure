# agid-open-ms-no-postcode-grid

Montserrat (MS) P2 medium AGID open-geodata seed package.
...
- Country or region code: `MS`
- Stage: `core-role-fill`
- Package kind: `no-postcode-grid`
...
- The no-postcode grid is a fallback validation aid, not an official postcode system.
