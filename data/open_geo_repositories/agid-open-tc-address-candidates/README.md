# agid-open-tc-address-candidates

Turks and Caicos Islands (TC) P2 medium AGID open-geodata seed package.
...
- Country or region code: `TC`
- Stage: `core-role-fill`
- Package kind: `address-candidates`
- Publication state: `blocked-until-license-review`
