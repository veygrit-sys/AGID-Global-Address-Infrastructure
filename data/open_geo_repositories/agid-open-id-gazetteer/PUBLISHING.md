...
```text
dawnportinfo-design/agid-open-id-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-id-gazetteer --public --description "AGID source-linked gazetteer seed for Indonesia"
git init
git add .
git commit -m "Seed ID AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-id-gazetteer.git
