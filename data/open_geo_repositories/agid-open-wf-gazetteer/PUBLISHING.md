...
```text
dawnportinfo-design/agid-open-wf-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-wf-gazetteer --public --description "AGID source-linked gazetteer seed for Wallis and Futuna"
git init
git add .
git commit -m "Seed WF AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-wf-gazetteer.git
