...
```text
dawnportinfo-design/agid-open-kh-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-kh-gazetteer --public --description "AGID source-linked gazetteer seed for Cambodia"
git init
git add .
git commit -m "Seed KH AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-kh-gazetteer.git
