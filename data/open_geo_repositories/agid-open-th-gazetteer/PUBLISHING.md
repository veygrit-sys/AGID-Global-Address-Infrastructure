...
```text
dawnportinfo-design/agid-open-th-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-th-gazetteer --public --description "AGID source-linked gazetteer seed for Thailand"
git init
git add .
git commit -m "Seed TH AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-th-gazetteer.git
