...
```text
dawnportinfo-design/agid-open-cl-sg-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-cl-sg-gazetteer --public --description "AGID source-linked gazetteer seed for Salas y Gomez Island"
git init
git add .
git commit -m "Seed CL-SG AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-cl-sg-gazetteer.git
