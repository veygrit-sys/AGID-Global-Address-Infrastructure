...
```text
dawnportinfo-design/agid-open-ki-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-ki-gazetteer --public --description "AGID source-linked gazetteer seed for Kiribati"
git init
git add .
git commit -m "Seed KI AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-ki-gazetteer.git
