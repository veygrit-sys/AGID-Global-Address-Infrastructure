...
```powershell
gh repo create dawnportinfo-design/agid-open-xu-gazetteer --public --description "AGID source-linked gazetteer seed for Akrotiri"
git init
git add .
git commit -m "Seed XU AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-xu-gazetteer.git
