...
```powershell
gh repo create dawnportinfo-design/agid-open-cygl-gazetteer --public --description "AGID source-linked gazetteer seed for Cyprus Green Line"
git init
git add .
git commit -m "Seed CYGL AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-cygl-gazetteer.git
