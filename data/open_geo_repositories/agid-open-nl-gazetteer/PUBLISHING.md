...
```text
dawnportinfo-design/agid-open-nl-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-nl-gazetteer --public --description "AGID source-linked gazetteer seed for Netherlands"
git init
git add .
git commit -m "Seed NL AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-nl-gazetteer.git
