...
```text
dawnportinfo-design/agid-open-ax-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-ax-gazetteer --public --description "AGID source-linked gazetteer seed for Åland Islands"
git init
git add .
git commit -m "Seed AX AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-ax-gazetteer.git
