...
```powershell
gh repo create dawnportinfo-design/agid-open-bt-t-gazetteer --public --description "AGID source-linked gazetteer seed for Bir Tawil"
git init
git add .
git commit -m "Seed BT_T AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-bt-t-gazetteer.git
