...
```powershell
gh repo create dawnportinfo-design/agid-open-pmr-gazetteer --public --description "AGID source-linked gazetteer seed for Transnistria"
git init
git add .
git commit -m "Seed PMR AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-pmr-gazetteer.git
