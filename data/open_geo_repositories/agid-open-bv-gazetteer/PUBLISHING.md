...
```text
dawnportinfo-design/agid-open-bv-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-bv-gazetteer --public --description "AGID source-linked gazetteer seed for Bouvet Island"
git init
git add .
git commit -m "Seed BV AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-bv-gazetteer.git
