...
```text
dawnportinfo-design/agid-open-fo-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-fo-gazetteer --public --description "AGID source-linked gazetteer seed for Faroe Islands"
git init
git add .
git commit -m "Seed FO AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-fo-gazetteer.git
