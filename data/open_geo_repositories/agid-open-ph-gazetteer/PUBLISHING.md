...
```text
dawnportinfo-design/agid-open-ph-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-ph-gazetteer --public --description "AGID source-linked gazetteer seed for Philippines"
git init
git add .
git commit -m "Seed PH AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-ph-gazetteer.git
