...
```text
dawnportinfo-design/agid-open-nr-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-nr-gazetteer --public --description "AGID source-linked gazetteer seed for Nauru"
git init
git add .
git commit -m "Seed NR AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-nr-gazetteer.git
