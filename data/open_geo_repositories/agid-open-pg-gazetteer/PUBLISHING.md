...
```text
dawnportinfo-design/agid-open-pg-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-pg-gazetteer --public --description "AGID source-linked gazetteer seed for Papua New Guinea"
git init
git add .
git commit -m "Seed PG AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-pg-gazetteer.git
