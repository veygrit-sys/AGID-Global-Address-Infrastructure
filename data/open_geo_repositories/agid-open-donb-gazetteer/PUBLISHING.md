...
```text
dawnportinfo-design/agid-open-donb-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-donb-gazetteer --public --description "AGID source-linked gazetteer seed for Donbas"
git init
git add .
git commit -m "Seed DONB AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-donb-gazetteer.git
