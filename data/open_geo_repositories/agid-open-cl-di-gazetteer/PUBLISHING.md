...
```powershell
gh repo create dawnportinfo-design/agid-open-cl-di-gazetteer --public --description "AGID source-linked gazetteer seed for Desventuradas Islands"
git init
git add .
git commit -m "Seed CL-DI AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-cl-di-gazetteer.git
