...
```powershell
gh repo create dawnportinfo-design/agid-open-kp-gazetteer --public --description "AGID source-linked gazetteer seed for North Korea"
git init
git add .
git commit -m "Seed KP AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-kp-gazetteer.git
