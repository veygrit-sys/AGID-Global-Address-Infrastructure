...
```powershell
gh repo create dawnportinfo-design/agid-open-scsd-gazetteer --public --description "AGID source-linked gazetteer seed for South China Sea Islands"
git init
git add .
git commit -m "Seed SCSD AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-scsd-gazetteer.git
