# agid-open-tf-address-candidates

French Southern and Antarctic Lands (TF) P1 high AGID open-geodata recovery seed.
...
- Country or region code: `TF`
- Recovery track: `gazetteer-only-recovery`
- Present local core role: `gazetteer`
- Missing core roles: `address`, `geocoding`, `admin-boundary`
- Publication state: `blocked-until-three-role-conformance`
...
- This recovery seed uses neutral technical identifiers for territory or special-region records.
