...
```text
dawnportinfo-design/agid-open-be-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-be-gazetteer --public --description "AGID source-linked gazetteer seed for Belgium"
git init
git add .
git commit -m "Seed BE AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-be-gazetteer.git
