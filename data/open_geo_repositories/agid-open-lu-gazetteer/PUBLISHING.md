...
```text
dawnportinfo-design/agid-open-lu-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-lu-gazetteer --public --description "AGID source-linked gazetteer seed for Luxembourg"
git init
git add .
git commit -m "Seed LU AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-lu-gazetteer.git
