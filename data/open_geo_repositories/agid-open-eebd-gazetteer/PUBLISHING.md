...
```powershell
gh repo create dawnportinfo-design/agid-open-eebd-gazetteer --public --description "AGID source-linked gazetteer seed for Ethiopia-Eritrea Border Area"
git init
git add .
git commit -m "Seed EEBD AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-eebd-gazetteer.git
