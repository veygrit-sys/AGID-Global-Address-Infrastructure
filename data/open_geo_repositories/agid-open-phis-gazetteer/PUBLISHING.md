...
```powershell
gh repo create dawnportinfo-design/agid-open-phis-gazetteer --public --description "AGID source-linked gazetteer seed for Pheasant Island"
git init
git add .
git commit -m "Seed PHIS AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-phis-gazetteer.git
