...
```text
dawnportinfo-design/agid-open-nc-gazetteer
```
...
```powershell
gh repo create dawnportinfo-design/agid-open-nc-gazetteer --public --description "AGID source-linked gazetteer seed for New Caledonia"
git init
git add .
git commit -m "Seed NC AGID gazetteer pack"
git branch -M main
git remote add origin https://github.com/dawnportinfo-design/agid-open-nc-gazetteer.git
